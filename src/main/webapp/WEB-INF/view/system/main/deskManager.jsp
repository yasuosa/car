...
<div id="indexViewNewsDiv" style="padding: 10px;display: none;">
...
<script type="text/javascript" >
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用任鹏宇汽车出租系统。当前时间为： "+newDate+"　"+week;
    ...
    function viewNews(id) {
        $.get("${pageContext.request.contextPath}/news/loadNewsById.action",
            {id:id},
        function (data) {
           layer.open({
                type:1,
