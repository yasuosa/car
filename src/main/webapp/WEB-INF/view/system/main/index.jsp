...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${pageContext.request.contextPath}/resources/images/face.jpg"
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${pageContext.request.contextPath}/resources/page/main.html"><i
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2019 任鹏宇</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${pageContext.request.contextPath}/menu/loadIndexLeftMenu.action" //获取菜单json地址
        });
