...
<div id="newsBar" style="display: none;">
    ...
    <a class="layui-btn layui-btn-yellow layui-btn-xs" lay-event="look">查看</a>
</div>
<!-- 数据表格结束 -->
...
<div style="display: none;padding: 20px" id="saveOrUpdateDiv">
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item" style="text-align: center;">
                ...
                <button type="reset"  id="dataFrmRestBtn" class="layui-btn layui-btn-warm layui-btn-sm layui-icon layui-icon-refresh">重置
                </button>
        </div>
    </form>
...
<script type="text/javascript">
    ...
    layui.extend({
    ...
    }).use(['jquery', 'layer', 'form', 'table', 'dtree','laydate','layedit'], function () {
        var $ = layui.jquery;
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'content', title: '公告备注', align: 'center'}
        ...
        $('#dataFrmRestBtn').click(function () {
           layedit.setContent(contentEdit,"");
        });
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些公告么', function (index) {
                //向服务端发送删除指令
