...
<form class="layui-form" method="post" id="searchFrm">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="loginame" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="text" name="realname" placeholder="请输入用户姓名" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="loginname" lay-verify="required" placeholder="请输入用户登录名称" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">身份证号:</label>
                <div class="layui-input-block">
                    <input type="text" name="identity" placeholder="请输入用户身份证" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
...
<%--用户分配菜单的弹出层开始--%>
<div style="padding: 20px ; display: none " id="selectUserRole" >
    <table class="layui-hide" id="roleTable" lay-filter="userTable"></table>
</div>
<%--用户分配菜单的弹出层结束--%>
    ...
    layui.extend({
            ...
            , cols: [[   //列表数据
                ...
                , {
                    field: 'sex', title: '性别', align: 'center', width: "80", templet: function (d) {
                        return d.sex == '1' ? '<font color=blue>男</font>' : '<font color=yellow >女</font>'
                    }
                }
                , {
                ...
                , {fixed: 'right', title: '操作', toolbar: '#userBar', align: 'center', width: "400"}
            ]]
        })
        //模糊查询
        ...
        table.on('tool(userTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                ...
                layer.confirm('真的删除【' + data.realname + '】行么', function (index) {
                    //向服务端发送删除指令
                ...
                layer.confirm('确认重置【' + data.realname + '】密码吗(默认密码123456)', function (index) {
                    //向服务端发送删除指令
        ...
        function openselectUserRole(data) {
            ...
            mainIndex = layer.open({
                ...
                yes:function(index,layerp){
                    ...
                    $.post(
                        "${pageContext.request.contextPath}/user/saveUserRole.action",
                        params,
                        function (obj) {
                            layer.msg(obj.msg);
                ...
                success: function (index) {
                    roleTableIns = table.render({
                        ...
                        , title: '分配'+data.realname+'的角色'//数据导出来的标题
                        , cellMinWidth: 100 //设置列的最小默认宽度
                        , cols: [[   //列表数据
                            {type: 'checkbox', fixed: 'left'}
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的删除选中的这些用户么', function (index) {
                //向服务端发送删除指令
